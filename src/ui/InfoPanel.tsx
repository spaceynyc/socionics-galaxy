    ...
    <AnimatePresence>
      {t && (
        <motion.aside
          ...
          className="glass fixed right-5 top-5 z-20 w-[380px] max-w-[calc(100vw-40px)] rounded-2xl p-4"
        >
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 grid grid-cols-4 gap-2">
              {t.functions.map((fn, idx) => (
                <div
                  key={fn + idx}
                  className="rounded-xl border border-white/10 bg-black/25 px-2 py-2"
                >
                  <div className="text-[10px] text-white/45">{idx + 1}</div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 max-h-[240px] rounded-xl border border-white/10 bg-black/20" style={{ overflowY: "auto", overflowX: "visible" }}>
          ...
          <p className="mt-3 text-[11px] text-white/45">
            Click a relation to highlight it. Hover the badge for a description.
          </p>
        </motion.aside>
      )}
    </AnimatePresence>
